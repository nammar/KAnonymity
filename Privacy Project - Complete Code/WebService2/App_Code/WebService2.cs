...
public class WS2_Implementation : IWebService2
{
    ...
    public string[][] getPrivacyPolicyArray(int WS_ID, int Target_WS_ID, string strTargetMethodName, ref Guid gid, ref string strIncentive)
    {
        ...
        catch (Exception ex)
        {
            ...
            File.AppendAllText(@dataFile, "WS2, getPrivacyPolicyArray: " + ex.Message.ToString());
        }        
    ...
    public string getLab2Results(int patient_id, ref string test_results)
    {
        ...
        test_results = "WS2 Test Results are Excellent\n";
        return "WS2/getLab2Results\n" + strReturnMessage;
    }
