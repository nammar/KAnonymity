<%@ Page Title="Privacy Requirements" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="PrivacyRequirements.aspx.cs" Inherits="About" %>

<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
     <table border="0" align=left>
           <tr>
              <td class="style1"><font size="5"><b>Client Privacy Requirements</b></font></td>
          </tr>
          <tr><td></td></tr>
          <tr><td><b><asp:Label ID="lblStatusMessage_AddRuleItemToClient" runat="server"></asp:Label></b></td></tr>
          <tr>
              <td class="style1"><br /><b>Privacy Rule Items - Possibilities Available for Client (full set of privacy rules and 
        constituent items to choose from)</b></td>
          </tr>
          <tr><td class="style1"><u>AddToClient</u> adds the item to the grid Privacy Rules Items for Client below</td></tr>
          <tr>
              <td class="style1"></td>
          </tr>
     </table>   
    ...
    <p>
        ...
        <table border="0" align=left>
          <tr><td></td></tr>
          <tr><td></td></tr>
          <tr><td><b><asp:Label ID="lblStatusMessage_ClientPrivacyRules" runat="server"></asp:Label></b></td></tr>
           <tr><td class="style1"><br /><b>Privacy Rules Items for Client (Rule Items available to be used in 
                 a propositional formula.)</b></td>
          </tr>
         <tr><td class="style1"><u>SelectForAssertion</u> adds the item to the Assertion Form below</td></tr>
         <tr><td class="style1"></td></tr>
          <tr>
             <td>
                 <asp:GridView ID="grdClientPrivRuleItems" runat="server" AutoGenerateColumns="False" 
                     DataSourceID="SqlDataSource3" Width="915px" 
                     AutoGenerateDeleteButton="True" 
                     onrowdeleting="grdClientPrivRuleItems_RowDeleting" 
                     onselectedindexchanged="grdClientPrivRuleItems_SelectedIndexChanged" AutoGenerateSelectButton="True" 
                     onrowdatabound="grdClientPrivRuleItems_RowDataBound">
                     <Columns>
                         <asp:BoundField DataField="rule_name" HeaderText="rule_name" 
                             SortExpression="rule_name" />
                 ...
                 <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                     ConnectionString="<%$ ConnectionStrings:WSProjectConnectionString %>"                      
                     SelectCommand="spGetPrivacyRuleSetItems_Client" 
                     SelectCommandType="StoredProcedure" 
                     DeleteCommand="spDelete_PrivacyRuleSetItem_FromGrid" 
          ...
          <tr>
                <td class="style1"><b>Add Client Assertion</b></td>
          </tr>
          ...
          <table border="0" style="border-width: thin; border-color:#000000;border-style: solid;">
              ...
              <tr><td></td></tr> 
               <tr>
                    <td><asp:Label ID="lbl4" runat="server" Text="Weight:"></asp:Label></td> 
                     <td><asp:TextBox ID="txtWeight" runat="server" Width="150px" Enabled="True"></asp:TextBox> </td>                   
              </tr> 
              <tr><td></td></tr> 
               <tr>
                    <td><asp:Label ID="lbl5" runat="server" Text="Mandatory Flag:"></asp:Label></td>  
                    <td>
          ...
          <table>
          <tr><td class="style1"></td></tr> 
          <tr><td class="style1"><b>Assertions for Client (note: if multiple instances of a resource for a method, weight and mandatory flag must be identical)</b></td></tr>          
          <tr>
                <td>
                    <asp:GridView ID="AssertionsGrid" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:CheckBoxField DataField="mandatory_flag" HeaderText="mandatory_flag" 
                                SortExpression="mandatory_flag" />
                            <asp:BoundField DataField="Rule_ID" HeaderText="Rule_ID" InsertVisible="False" 
                                ReadOnly="True" SortExpression="Rule_ID" />
                            <asp:BoundField DataField="rule_name" HeaderText="rule_name" 
                                SortExpression="rule_name" />
          ...
          <tr><td>
              <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                  ConnectionString="<%$ ConnectionStrings:WSProjectConnectionString %>" 
                  SelectCommand="spGetAssertions_Client" SelectCommandType="StoredProcedure" 
                  DeleteCommand="spDelete_AssertionClient_FromGrid" 
                  DeleteCommandType="StoredProcedure">
                  <DeleteParameters>
                      <asp:Parameter Direction="ReturnValue" Name="RETURN_VALUE" Type="Int32" />
                      <asp:Parameter Name="ws_id" Type="Int32" />
