...
public class WS3_Implementation : IWebService3
{
    ...
    public string[][] getPrivacyPolicyArray(int WS_ID, int Target_WS_ID, string strTargetMethodName, ref Guid gid, ref string strIncentive)
    {
        ...
        catch (Exception ex)
        {
            ...
            File.AppendAllText(@dataFile, "WS3, getPrivacyPolicyArray: " + ex.Message.ToString());
        }
    ...
    protected void populateServiceAssertionsArray(int WS_ID, int Target_WS_ID, string strTargetMethodName)
    {
        ...
        //  PP info on the client local database - available to be accessed by this client stored procedure). 
    ...
    public string getLab3Results(int patient_id, ref string test_results)
    {
        ...
        test_results = "WS3 Test Results are Excellent\n";
        return "WS3/getLab3Results\n" + strReturnMessage;
    }
