...
public class WS4_Implementation : IWebService4
{
    ...
    public string[][] getPrivacyPolicyArray(int WS_ID, int Target_WS_ID, string strTargetMethodName, ref Guid gid, ref string strIncentive)
    {
        ...
        catch (Exception ex)
        {
            ...
            File.AppendAllText(@dataFile, "WS4, getPrivacyPolicyArray: " + ex.Message.ToString());
        }
    ...
    {
        test_results = "WS4 Test Results are Excellent\n";
        return "WS4/getLab4Results\n";
    }
